...
const AITools = {
    publicelfare: [
        {
            icon: "",
            title: "Elysia-主站",
            link: "https://elysiver.h-e.top",
            text: "https://linux.do/t/topic/1175087\n允许任意IP\n签到"
        },
        {
            icon: "",
            title: "Elysia-备用",
            link: "https://elysia.h-e.top",
            text: "https://linux.do/t/topic/1175087\n优化线路 允许任意IP RPM稍低\n签到"
        },
        ...
        },
        {
            icon: "",
            title: "🍌 nano-banana",
            link: "https://nano-banana.dev88.me/",
            text: "👈dev88的大香蕉"
        },
        {
            icon: "",
            title: "Huan API",
            link: "https://ai.huan666.de/",
            text: "和阿焕有友联了\n签到"
        },
        ...
        //     icon: "",
        //     title: "23公益站",
        //     link: "https://sdwfger.edu.kg/console",
        //     text: "跑路啦"
        // },

        {
            icon: "",
            title: "Ketchup AI - Free Unlimited AI Image Generator",
            link: "https://ketchup-ai.com/",
            text: "无限的图片生成！\n那还说啥了，🍅🐮🍺"
        },

        {
            icon: "",
            title: "包子铺-Donehub",
            link: "https://api.5202030.xyz/",
            text: "包子铺的Donehub\n好像渠道快死完了，白嫖这么久，等发工资了投喂一下"
        },
        {
            icon: "",
            title: "包子铺-NewApi",
        ...
        },
        {
            icon: "",
            title: "SWT-API",
            link: "https://api.lhyb.dpdns.org/pricing",
            text: "https://linux.do/t/topic/1106811\n都不知道咋说了，总是是白嫖大王"
        },
        {
            icon: "",
            title: "SWT-API-备用",
            link: "https://api2.lhyb.dpdns.org/",
            text: "SWT-API"
        },
        {
            icon: "",
            title: "SWT-API-备用2",
            link: "https://new-api.koyeb.app",
            text: "SWT-API"
        },
        {
            icon: "",
    ...
    supplement: [
        ...
        },
        {
            icon: "",
            title: "浮生十梦",
            link: "https://immortal.game.elysia.h-e.top/",
            text: "Elysia补充"
        },
        {
            icon: "",
    ...
    publicData: [
        {
            icon: "",
            title: "Artificial Intelligence • freemediaheckyeah",
            link: "https://fmhy.net/ai",
            text: "AI资料库，实际上你也能找到其他的资料"
        },
        {
            icon: "",
            title: "oneapi与newapi的api控制文档",
            link: "https://kuraa.cc/archives/oneapiyu-newapide-apikong-zhi-wen-dang",
            text: "为什么不看文档呢，是不爱看吗"
        },
    ]
}
